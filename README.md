...
<html lang="en">
    ...
    <body>
        <h1>My Timetable</h1>
        <img src="logo.png" heigth="100"width="300">
        <table border="5">
            <tr>
                <td align="center" colspan="10">TIME TABLE</td>
            </tr>
            <tr>
                <td colspan="5">Reg number : 22008111</td>
                <td colspan="5">Name : BERGIN</td>
...
![image](https://user-images.githubusercontent.com/119404594/215346689-e358db25-1703-4192-a8da-bc1f5205fec6.png)
